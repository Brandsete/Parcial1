...
salir_menu=tk.Menu(menu_inicio)
menu_inicio.add_cascade(label="salir",command=ventana)
...
btn_salir.place(relx=0.90, rely=0.95, anchor='center', relwidth=0.3, relheight=0.1)
